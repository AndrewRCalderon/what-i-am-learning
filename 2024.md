...
| History of Agile Movement in Programming     | [Link](https://martinfowler.com/articles/newMethodology.html)     | Testing, Programming  | In today's environment, the most common methodology is code and fix. The Agile Movement proposed a series of values, principle and practices meant to render software development more adaptive, and to decouple the notion of it being an engineering discipline from pernious analogies to other types of engineering that created unrealistic expectations for how deterministic programming can be. The artcle delves into the history of Agile and it's derivatives, like Extreme Programming, and its implications for management, teams and more.         | Martin Fowler |
